function ConvertFrom-SysmonRegistrySetEvent {
<#
.Synopsis
...
ConvertFrom-SysmonRegistrySetEvent $SysmonEvent
...
Set-Alias -Name ConvertFrom-SysmonType13 -Value ConvertFrom-SysmonRegistrySetEvent -Description “ConvertFrom Sysmon Event type 1 - Process Create”

#$SysmonEvent = Get-WinEvent -FilterHashtable @{logname="Microsoft-Windows-Sysmon/Operational";Id=13;} | select -first 1
#ConvertFrom-SysmonRegistrySetEvent $SysmonEvent -Verbose